...
-- Tiempo de generación: 24-04-2018 a las 01:40:57
...
(1, 'pablo.vicencio@clinicarioblanco.cl', 'bcfec6fe1842e8725be736c5576b0a0d', 'pablo', 96643838, '1993-03-03', b'1', '2018-03-01', 1, 2),
...
INSERT INTO `nut_comidas` (`id_nut_com`, `desc_nut_com`, `vig_nut_com`) VALUES
(1, 'Desayuno', b'1'),
(2, 'Colación', b'1'),
(3, 'Almuerzo', b'1'),
(4, 'Once', b'1'),
...
CREATE TABLE IF NOT EXISTS `nut_det_dieta` (
  ...
  `fk_nut_det_uni` int(11) NOT NULL,
  `fk_nut_dieta` int(11) NOT NULL,
  `vig_nut_det` bit(1) DEFAULT NULL,
  `nota_nut_det` varchar(150) DEFAULT NULL,
