...
<title>D3 - Cargar Entrenamiento</title>
          ...
          <div class="row">
            ...
            <div class="col-4">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <select size="1" name="vel" class="custom-select" id="vel" type="text">
                                <option value="" selected disabled>Velocidad de Ejecución</option>
